    ...
    return (
        <div className="z-0">
            <div className="hero min-h-screen" style={{ backgroundImage: `url(${BannerImage})` }}>
                ...
                <div className="flex items-center flex-col lg:mb-60">
                    ...
                    <form onSubmit={handleSubmit} className="flex md:flex-row flex-col gap-2 md:gap-0 items-center justify-center mt-5">
                        ...
                        <input className="btn px-7 bg-[#FF444A] font-medium text-white md:rounded-l-none normal-case" type="submit" value="Search" />
                    </form>
                </div>
            </div>
